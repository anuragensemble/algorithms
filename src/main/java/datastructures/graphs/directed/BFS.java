...
public class BFS {
    ...
    // TODO: Scenarios where there an unprocessed vertex may be in queue twice. How to handle that?
    public void bfs(Digraph graph) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(bfs.path(1));
        System.out.println(bfs.path(2));
        System.out.println(bfs.path(3));
